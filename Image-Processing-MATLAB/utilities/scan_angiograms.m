function scan_angiograms()
%% Scan angiograms for the completeness of data - sanity test
%
...
%
% Date: 01-Nov-2019; Last revision: 15-Nov-2019
%
...
fileValidID = fopen(fullfile(scanDir, 'valid_cases.txt'),'w');
num = sum([scanRes.IsValid]);
fprintf(fileValidID,'No. of valid cases: %d\n\n',num);

fileInValidID = fopen(fullfile(scanDir, 'invalid_cases.txt'),'w');
