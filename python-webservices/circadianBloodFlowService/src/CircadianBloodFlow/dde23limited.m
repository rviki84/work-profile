function sol = dde23limited(ddefun,lags,history,tspan,options,varargin)
...
%   $Revision: 1.5.4.14 $  $Date: 2010/11/17 11:26:10 $

solver_name = 'dde23';
timerID = tic;
MAX_RUNTIME = 600; % max runtime limited to 10 minutes
