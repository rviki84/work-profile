function output = modelQuery_openloop(params, modelParams, subject)

% Open-loop configuration, HR is fixed
modelParams.HR = params(6) * 75;
...
ddefun = @(t,y,Z,modelParams) my_osc_openloop(t,y,Z,modelParams);
...
% Heart rate is prescribed in the open loop -case
output(3) = modelParams.HR;
