//****************************************************************
// @doc
// @module DEFINES.h | Enthält allgemeine Definitionen.
// @end
//----------------------------------------------------------------
// Definitionen fuer MKS  !!
// Modulname:    $Source: C:/c51_buecher/Teil2/software/Inc_C51b/rcs/Defines.h $
// User:         $Author: MEBA $
...
// Beschreibung:
// 02.12.2000 Änderung !!
// Alle Definitionen der Makros sowie der Deklaration der Unions
// befinden sich nun im H-File MAKROS.h.
//***************************************************************
...
//***************************************************************
 ...
 #define DEFINES
//***************************************************************
// @type Allgemeine Definitionen | Allgemeine Definitionen für z. B.
// vereinfachte Schreibweise in C, Definition von Speicherbereichen, usw.
//***************************************************************
 #define uchar unsigned char // @define uchar |
 #define uint  unsigned int  // @define uint  |
 #define ulong unsigned long // @define ulong |
//***************************************************************
/* definition from areas */
#define DATA    0x00    // @define DATA  |
#define IDATA   0x00	// @define IDATA |
#define PDATA   0xFE    // @define PDATA |
#define XDATA   0x01    // @define XDATA |
#define CODE    0xFF    // @define CODE  |


/* definition from states */

#define NOT_USED 0  // @define NOT_USED  |
#define USED     1  // @define     USED  | 

#define NO_DEF 0xFF // @define NOT_DEF   |

#define OK      0   // @define OK        |
#define ERR    -1   // @define ERR       |

#define ON      1   // @define ON        |
#define OFF     0   // @define OFF       |

#define ENABLE  1   // @define ENABLE    |
#define DISABLE 0   // @define DISABLE   |

#define CLEAR   0   // @define CLEAR     |
#define SET     1   // @define SET       |

#define LEVEL   0   // @define LEVEL     |
#define EDGE    1   // @define EDGE      |


#ifndef __A51__
// Im A51 sind HIGH und LOW Macro-Instruktionen
//  #define LOW     0
//  #define HIGH    1
#endif

#define STOP    0   // @define STOP      |			    

#define START   1   // @define START     |

#define TRUE    1   // @define TRUE      |
#define FALSE   0   // @define FALSE     |

/* Definitionen fuer Biteingaben */
